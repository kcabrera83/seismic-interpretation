...
def test_models():
    results = {}
    results['facies'] = evaluate_model(os.path.join(MODEL_DIR, 'facies_classifier.pkl'), X, y)
    results['porosity'] = evaluate_model(os.path.join(MODEL_DIR, 'porosity_predictor.pkl'), X, y)
    return results
